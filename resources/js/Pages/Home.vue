<template>
    ...
    <MainLayout>
        <!-- Hero Section -->
        <div class="relative h-auto py-16 flex flex-col items-center justify-center bg-white">
            <!-- Teks Hero -->
            <div class="text-center z-[1] relative">
                <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl lg:text-6xl mt-32 px-64">
                    Solusi Peralatan Industri Terbaik untuk Kesuksesan Bisnis Anda
                </h1>
                <p class="mt-12 text-xl text-gray-600 max-w-3xl mx-auto">
                    Your trusted partner in heavy equipment solutions. We provide quality machinery
                    for construction, mining, and industrial needs.
                </p>
                <div class="mt-10">
                    <a
                        href="#categories"
            ...
            <div class="relative w-full mt-96 flex flex-col items-center">
                ...
                <div class="absolute bottom-0 z-[1] flex justify-center pointer-events-none">
                    <img
                ...
                <div class="gradien-container absolute bottom-0 z-[0] w-full overflow-hidden px-4 sm:px-6 lg:px-20 mask-fade infinite-scroll-cornered">
                    <!-- Scroll Wrapper -->
        ...
        <div class="py-24 bg-white sm:py-32">
            <div class="max-w-7xl mx-auto px-6 lg:px-8">
                <div class="mx-auto max-w-2xl lg:text-center">
                    <h2 class="text-base font-semibold leading-7 text-indigo-600">Our Values</h2>
                ...
                <div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
                    <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
                        <div v-for="(value, index) in coreValues" :key="index" class="flex flex-col">
...
import {ShieldCheckIcon, TruckIcon, WrenchIcon} from '@heroicons/vue/24/outline'
...
const coreValues = [
    {
        name: 'Reliability',
        description: 'We provide only the most reliable and tested equipment for your needs.',
        icon: ShieldCheckIcon,
    },
    {
        name: 'Efficiency',
        description: 'Our equipment is selected to maximize your productivity and minimize costs.',
        icon: TruckIcon,
    },
    {
        name: 'Service',
...
const categories = [
    {
        ...
        name: 'General Pallet',
        slug: 'general pallet',
        image: '/images/general pallet.png',
    },
    {
        id: 2,
        name: 'Generator Set',
        slug: 'generator set',
        image: '/images/generator set.png',
    },
    {
        id: 3,
        name: 'Industrial Equipment Support',
        slug: 'industrial equipment support',
        image: '/images/industrial equipment support.png',
    },
]
</script>
...
:root {
    --fade-gradient: linear-gradient(to right, rgba(255, 255, 255, 0) 5%, rgba(255, 255, 255, 0.5) 10%, rgba(255, 255, 255, 1) 40%, rgba(255, 255, 255, 1) 60%, rgba(255, 255, 255, 0.5) 90%, rgba(255, 255, 255, 0) 100%);
    --fade-gradient-reverse: linear-gradient(to left, rgba(255, 255, 255, 0) 5%, rgba(255, 255, 255, 0.5) 10%, rgba(255, 255, 255, 1) 40%, rgba(255, 255, 255, 1) 60%, rgba(255, 255, 255, 0.5) 90%, rgba(255, 255, 255, 0) 100%);
}
